...
/**
 * Registry helper for Minecraft's {@link net.minecraft.registry.Registry Registry}.
 * 
 * <h2>Example:</h2>
...
public class ModRegistry {
  ...
  /**
   * Registers a new {@link net.minecraft.item.Item Item}
   *
   * @param item
   *        The {@link net.minecraft.item.Item Item} to register
   * @param name
   *        The name of the {@link net.minecraft.item.Item Item}
   * 
   * @return Registered instance of the {@link net.minecraft.item.Item Item}
   * 
   * <h2>Example:</h2>
  ...
  /**
   * Registers a new {@link net.minecraft.block.Block Block}
   *
   * @param block
   *        The {@link net.minecraft.block.Block Block} to register
   * @param name
   *        The name of the {@link net.minecraft.block.Block Block}
   * 
   * @return Registered instance of the {@link net.minecraft.block.Block Block}
   * 
   * <h2>Example:</h2>
   *<pre><code>public void register() {
  ...
  /**
   * Registers a new {@link net.minecraft.block.Block Block} with a {@link net.minecraft.item.BlockItem BlockItem}
   *
   * @param block
   *        The {@link net.minecraft.block.Block Block} to register
   * @param settings
   *        The {@link net.minecraft.item.Item.Settings Item.Settings} of the {@link net.minecraft.item.BlockItem BlockItem}
   * @param name
   *        The name of the {@link net.minecraft.block.Block Block}
   * 
   * @return Registered instance of the {@link net.minecraft.block.Block Block}
   ...
   *        The {@link net.minecraft.block.Block Block} to register
   * @param group
   *        The {@link net.minecraft.item.ItemGroup ItemGroup} of the {@link net.minecraft.item.BlockItem BlockItem}
   * @param name
   *        The name of the {@link net.minecraft.block.Block Block}
   * 
   * @return Registered instance of the {@link net.minecraft.block.Block Block}
  ...
  public Block block(Block block, ItemGroup group, String name) {
    return block(block, new Item.Settings(), name);
  }

  /**
   * Registers a new {@link net.minecraft.block.entity.BlockEntityType BlockEntityType}
   * <p>You shouldn't use this unless you can't use {@link #blockEntity(net.fabricmc.fabric.api.object.builder.v1.block.entity.FabricBlockEntityTypeBuilder.Factory factory, String name, net.minecraft.block.Block... blocks) blockEntity()}
   *
   * @param <T>
   *        The {@link net.minecraft.block.entity.BlockEntity BlockEntity} being registered
   *
   * @param type
   *        The {@link net.minecraft.block.entity.BlockEntityType BlockEntityType} to register
   * @param name
   *        The name of the {@link net.minecraft.block.entity.BlockEntityType BlockEntityType}
   * 
   * @return {@link net.minecraft.block.entity.BlockEntityType BlockEntityType} of the registered {@link net.minecraft.block.entity.BlockEntity BlockEntity}
   * 
   * @see ClientRegistry
   */
  ...
  /**
   * Registers a new {@link net.minecraft.block.entity.BlockEntity BlockEntity}
   *
   * @param <T>
   *        The {@link net.minecraft.block.entity.BlockEntity BlockEntity} being registered
   *
   * @param factory
   *        The {@link net.fabricmc.fabric.api.object.builder.v1.block.entity.FabricBlockEntityTypeBuilder.Factory FabricBlockEntityTypeBuilder.Factory} of the {@link net.minecraft.block.entity.BlockEntity BlockEntity}
   * @param name
   *        The name of the {@link net.minecraft.block.entity.BlockEntity BlockEntity}
   * @param blocks
   *        The {@link net.minecraft.block.Block Block}(s) using this {@link net.minecraft.block.entity.BlockEntity BlockEntity}
   * 
   * @return {@link net.minecraft.block.entity.BlockEntityType BlockEntityType} of the registered {@link net.minecraft.block.entity.BlockEntity BlockEntity}
   * 
   * <h2>Example:</h2>
   ...
   *        The name of the {@link net.minecraft.block.entity.BlockEntity BlockEntity}
   * @param blocks
   *        The {@link rs.neko.mc.BlockRegistry BlockRegistry}(s) using this {@link net.minecraft.block.entity.BlockEntity BlockEntity}
   * 
   * @return {@link net.minecraft.block.entity.BlockEntityType BlockEntityType} of the registered {@link net.minecraft.block.entity.BlockEntity BlockEntity}
   * 
   * <h2>Example:</h2>
  ...
  /**
   * Registers a new {@link net.minecraft.entity.EntityType EntityType}
   * @param <T>
   *        The {@link net.minecraft.entity.Entity Entity} being registered
   *
   * @param builder
   *        The {@link net.fabricmc.fabric.api.object.builder.v1.entity.FabricEntityTypeBuilder FabricEntityTypeBuilder}
   * @param name
   *        The name of the {@link net.minecraft.entity.EntityType EntityType}
   * 
   * @return The registered {@link net.minecraft.entity.EntityType EntityType}
   * 
   * <h2>Example:</h2>
   *<pre><code>public void register() {
